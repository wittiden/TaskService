def block_user_subject(name: str) -> str:
    return f'{name}, ваш аккаунт в TaskService заблокирован'


def block_user_body(name: str) -> str:
    return f"""
<!DOCTYPE html>
<html lang="ru">
<head>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <p>
                ...
                <strong>заблокирован</strong> по решению администрации.
            </p>

...
class TokenConfig(BaseSettings):
    ...
    ACCESS_TOKEN_PRIVATE_KEY_PATH: str = 'certs/access-private.pem'
    ACCESS_TOKEN_PUBLIC_KEY_PATH: str = 'certs/access-public.pem'
    ACCESS_TOKEN_EXPIRE_MINUTES: int = 5
    ACCESS_TOKEN_AUDIENCE: str = 'access-api'

    REFRESH_TOKEN_ALGORITHM: str = 'RS256'
    REFRESH_TOKEN_PRIVATE_KEY_PATH: str = 'certs/refresh-private.pem'
    REFRESH_TOKEN_PUBLIC_KEY_PATH: str = 'certs/refresh-public.pem'

...
@inject
async def login_user_endpoint(request: Request, schema: LoginUserSchema, service: FromDishka[AuthUserCase], uow: FromDishka[ProgramUnitOfWork]) -> TokensInfoDTO:
...
@inject
async def logout_user_endpoint(request: Request, current_user: CurrentUser, service: FromDishka[AuthUserCase], uow: FromDishka[ProgramUnitOfWork]) -> None:
...
@inject
async def refresh_tokens_endpoint(request: Request, schema: RefreshSchema, service: FromDishka[AuthUserCase], uow: FromDishka[ProgramUnitOfWork]) -> TokensInfoDTO:
...
@inject
async def show_refresh_tokens_endpoint(request: Request, current_admin: CurrentAdmin, service: FromDishka[ShowRefreshTokenCase], uow: FromDishka[ProgramUnitOfWork], limit: int = 100, offset: int = 0) -> list[FullRefreshTokenInfoDTO]:
...
@inject
async def show_active_refresh_tokens_endpoint(request: Request, current_admin: CurrentAdmin, service: FromDishka[ShowRefreshTokenCase], uow: FromDishka[ProgramUnitOfWork], limit: int = 100, offset: int = 0) -> list[FullRefreshTokenInfoDTO]:
...
@inject
async def show_revoked_refresh_tokens_endpoint(request: Request, current_admin: CurrentAdmin, service: FromDishka[ShowRefreshTokenCase], uow: FromDishka[ProgramUnitOfWork], limit: int = 100, offset: int = 0) -> list[FullRefreshTokenInfoDTO]:
...
@inject
async def show_refresh_token_by_id_endpoint(request: Request, current_admin: CurrentAdmin, refresh_token_id: UUID, service: FromDishka[ShowRefreshTokenCase], uow: FromDishka[ProgramUnitOfWork]) -> FullRefreshTokenInfoDTO:
...
@inject
async def show_refresh_tokens_by_user_id_endpoint(request: Request, current_admin: CurrentAdmin, user_id: UUID, service: FromDishka[ShowRefreshTokenCase], uow: FromDishka[ProgramUnitOfWork]) -> list[FullRefreshTokenInfoDTO]:
...
@inject
async def delete_refresh_token_endpoint(request: Request, current_admin: CurrentAdmin, refresh_token_id: UUID, service: FromDishka[DeleteRefreshTokenCase], uow: FromDishka[ProgramUnitOfWork]) -> None:

...
@inject
async def create_standard_user_endpoint(request: Request, response: Response, schema: CreateUserSchema, service: FromDishka[CreateUserCase], uow: FromDishka[ProgramUnitOfWork]) -> SecurityUserInfoDTO:
...
@limiter.limit('10/minute')
@inject
async def create_vip_user_endpoint(request: Request, response: Response, schema: CreateUserSchema, service: FromDishka[CreateUserCase], uow: FromDishka[ProgramUnitOfWork]) -> SecurityUserInfoDTO:
...
@inject
async def create_admin_endpoint(request: Request, response: Response, schema: CreateUserSchema, service: FromDishka[CreateUserCase], uow: FromDishka[ProgramUnitOfWork]) -> SecurityUserInfoDTO:
...
@inject
async def close_my_user_endpoint(request: Request, response: Response, current_user: CurrentUser, service: FromDishka[DeleteUserCase], uow: FromDishka[ProgramUnitOfWork]) -> None:
...
@limiter.limit('10/minute')
@inject
async def delete_user_by_id_endpoint(request: Request, response: Response, current_admin: CurrentAdmin, user_id: UUID, service: FromDishka[DeleteUserCase], uow: FromDishka[ProgramUnitOfWork]) -> None:
    await service.delete_user(user_id)


@admin_users_router.get('/', response_model=list[UserInfoDTO], summary='Show users')
@inject
async def show_users_endpoint(current_admin: CurrentAdmin, service: FromDishka[ShowUserCase], uow: FromDishka[ProgramUnitOfWork], limit: int = 100, offset: int = 0) -> list[UserInfoDTO]:
    return await service.show_users(limit, offset)


@admin_users_router.get('/by-id/{user_id}', response_model=UserInfoDTO, summary='Show user by id')
@inject
async def show_user_by_id_endpoint(current_admin: CurrentAdmin, user_id: UUID, service: FromDishka[ShowUserCase], uow: FromDishka[ProgramUnitOfWork]) -> UserInfoDTO:
...
@inject
async def show_my_user_endpoint(request: Request, response: Response, current_user: CurrentUser, service: FromDishka[ShowUserCase], uow: FromDishka[ProgramUnitOfWork]) -> SecurityUserInfoDTO:
...
@inject
async def block_user_endpoint(request: Request, response: Response, current_admin: CurrentAdmin, user_id: UUID, service: FromDishka[ManageUserCase], uow: FromDishka[ProgramUnitOfWork]) -> None:
...
@limiter.shared_limit('20/minute', scope='manage_user_case')
@inject
async def unblock_user_endpoint(request: Request, response: Response, current_admin: CurrentAdmin, user_id: UUID, service: FromDishka[ManageUserCase], uow: FromDishka[ProgramUnitOfWork]) -> None:

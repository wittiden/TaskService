...
async def show_user_audits_endpoint(
    request: Request, response: Response, current_user: CurrentAdmin, case: FromDishka[ShowUserAuditCase], uow: FromDishka[UnitOfWork], offset: int = 0, limit: int = 100
...
async def show_user_audits_by_user_id_endpoint(
    current_user: CurrentAdmin, user_id: UUID, case: FromDishka[ShowUserAuditCase], uow: FromDishka[UnitOfWork], offset: int = 0, limit: int = 100
) -> list[FullUserAuditInfoDTO]:
...
async def show_user_audits_by_id_endpoint(
    current_user: CurrentAdmin, user_audit_id: UUID, case: FromDishka[ShowUserAuditCase], uow: FromDishka[UnitOfWork]

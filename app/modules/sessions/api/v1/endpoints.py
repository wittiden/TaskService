...
async def show_refresh_tokens_endpoint(
    response: Response, request: Request, current_user: CurrentAdmin, case: FromDishka[ShowRefreshTokenCase], uow: FromDishka[UnitOfWork], offset: int = 0, limit: int = 100
...
async def show_refresh_token_by_id_endpoint(
    current_user: CurrentAdmin, refresh_token_id: UUID, case: FromDishka[ShowRefreshTokenCase], uow: FromDishka[UnitOfWork]
...
async def delete_refresh_token_by_id_endpoint(
    response: Response, request: Request, current_user: CurrentAdmin, refresh_token_id: UUID, case: FromDishka[DeleteRefreshTokenCase], uow: FromDishka[UnitOfWork]
) -> None:
